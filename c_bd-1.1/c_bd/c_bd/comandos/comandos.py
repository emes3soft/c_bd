...
class CMD_SELECT:
    ...
    def __init__(self, conexao, tabelas : str, campos : str = "*", nomes_campos : str = None, joins : str = None, condicoes : str = None, 
    ...
    def cria_comando(self):
        ...
        campos = ""
        tabelas = self.tabelas.split(TC.separador)
...
def executar_comando(conexao, comando : object, execucao_automatica : bool = True):
    ...
    """
    from ..connector.conexao import CONEXAO as C
